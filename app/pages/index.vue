  ...
  <div>
    <section id="heroSearch" class="hero-search mtop-100 pt-0 pb-0">
      ...
      >
        <!-- Slide #1 -->
        <div
          class="slide--item bg-overlay bg-overlay-dark3 bg-section"
...
const slides = [
  {
    id: 1,
    img: "/images/slider/slide-bg/3.jpg",
    alt: "background 3",
  },
  {
    id: 2,
    img: "/images/slider/slide-bg/1.jpg",
    alt: "background 1",
  },
  {
    id: 3,
    img: "/images/slider/slide-bg/3.jpg",
    alt: "background 3 again",
  },
];
const properties = [
  {
